...
class AttentionMergedNetworkTanh(xtools.NominalNetwork):
    def __init__(self,featureDict):
        ...
        for i,filters in enumerate([64,32,32,15]):
            ...
            if i<3:
                ...
                self.cand_attention.extend([
                    keras.layers.Activation('tanh',name="cand_attention_activation"+str(i+1)),
                    keras.layers.Dropout(0.1,name='cand_attention_dropout'+str(i+1)),
                ])
...
network = AttentionMergedNetworkTanh
