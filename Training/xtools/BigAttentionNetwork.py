...
class BigAttentionNetwork(xtools.NominalNetwork):
    ...
    def extractFeatures(self,globalvars,cpf,npf,sv,muon,electron,gen=None):
        ...
        global_conv = addConvFeatures#self.applyLayers(addConvFeatures,self.global_features_conv)
        global_attention = addConvFeatures#self.applyLayers(addConvFeatures,self.global_features_attention)
        
        
        
        cpf_conv = self.applyLayers(self.addToConvFeatures(self.cpf_preproc(cpf),global_conv),self.cpf_conv)
        npf_conv = self.applyLayers(self.addToConvFeatures(self.npf_preproc(npf),global_conv),self.npf_conv)
        ...
        cpf_attention = self.applyLayers(self.addToConvFeatures(self.cpf_preproc(cpf),global_attention),self.cpf_attention)
        npf_attention = self.applyLayers(self.addToConvFeatures(self.npf_preproc(npf),global_attention),self.npf_attention)
